    ...
    <div class="section-card">
      ...
      <div class="hr-settings-grid" style="margin-top: 20px;">
        ...
        <div class="salary-details-pane">
          <div v-if="salarySelectedJT" class="section-card" style="border-style: dashed; background: #f8fafc; padding: 20px; border-radius: 12px;">
            <h3 style="margin-bottom: 20px; color: #1a2a3a;">Position: {{ salarySelectedJT.name }}</h3>
            <div class="salary-dual-config">
              <div class="salary-config-card" style="margin-bottom: 20px; padding: 15px; background: white; border-radius: 8px; border: 1px solid #e2e8f0;">
                <h4 style="font-size: 0.75rem; color: #64748b; text-transform: uppercase;">🏢 Monthly Salary</h4>
              ...
              <div class="salary-config-card" style="padding: 15px; background: white; border-radius: 8px; border: 1px solid #e2e8f0;">
                <h4 style="font-size: 0.75rem; color: #64748b; text-transform: uppercase;">☀️ Daily Wage</h4>
                <div class="form-grid" style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-top: 10px;">
      ...
      <div class="salary-global-fullwidth" style="margin-top: 40px; border-top: 1px solid #e2e8f0; padding-top: 30px;">
         <div class="section-header">
            <h3>⚙️ Global Payroll Configuration</h3>
            <p style="font-size: 0.8rem; color: #64748b;">System-wide parameters for calculating daily earnings and overtime.</p>
         </div>
         
         <div class="global-settings-horizontal-flex" style="display: flex; gap: 20px; flex-wrap: wrap; margin-top: 20px;">
            <div class="settings-category-group" style="flex: 1; min-width: 280px;">
